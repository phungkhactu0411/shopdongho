...
<head>
    ...
    <link rel="shortcut icon" type="images/png" href="<?php echo e(asset('public/frontend/images/icon.png')); ?>">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="<?php echo e(asset('public/frontend/images/logo.png')); ?>" style="width: ; height: 30px" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-8">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" style="background: #677a59">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(asset('public/frontend/images/HUBLOT2.png')); ?>" class="girl img-responsive" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(asset('public/frontend/images/HUBLOT.png')); ?>" class="girl img-responsive" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="<?php echo e(asset('public/frontend/images/HUBLOT1.png')); ?>" class="girl img-responsive" alt="" />
								</div>
							</div>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<img src="<?php echo e(asset('public/frontend/images/bigbang.jpg')); ?>" width="1160px">
				</div>
...
</html><?php /**PATH C:\xampp\htdocs\shop\resources\views/welcome.blade.php ENDPATH**/ ?>